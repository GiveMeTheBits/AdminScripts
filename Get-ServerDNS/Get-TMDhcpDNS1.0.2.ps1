...
$Servs = Get-DhcpServerInDC
#Get-TMDhcpDNS -ComputerName $Servs.dnsname | where {$_.DNS -ilike "*$($IP.IPAddressToString)*"} | Out-GridView


$fart = Get-TMDhcpDNS -ComputerName stlprint01 | where {$_.DNS -contains $OldIP.IPAddressToString}